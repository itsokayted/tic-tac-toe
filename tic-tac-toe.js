...
function gameplayLoop() {
    while (!winner) {
        const choice = prompt('Please select a space to play using numbers 0 through 8: ');
...
function changeTurn(curretTurn) {
    if (curretTurn === 'X') {
        return 'O'
    } else {
        return 'X'
...
function renderMessage() {
    console.log(`It is ${turn}'s turn, please chose a space`)
}
